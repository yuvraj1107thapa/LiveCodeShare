            ...
            <div className='px-4 py-5 flex-auto'>
              ...
              >
                ...
                <div className='flex flex-col justify-center'>
                  ...
                  <p className=''>
                    ...
                    compiler supports C++, JavaScript, Java and Python.{' '}
                  </p>
                  <br />
                  <p>
              ...
              >
                ...
                <div className='flex flex-col justify-center'>
                  ...
                  <p className=''>
                    New to coding? LIVECODESHARE's social platform allows users to
              ...
              >
                ...
                <div className='flex flex-col justify-center'>
                  ...
                  <br />
                  <p>
                    LIVECODESHARE comes with a built-in IDE where you and your
